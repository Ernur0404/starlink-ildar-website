...
(function () {
  ...
  var CONTACTS = {
    ...
    /* Если значение разное по языкам — пишем пару {kk, ru}.
       Если одинаковое (как телефон) — просто строкой. */
    company: {
      kk: 'ЖК Ташимов Э.К.',              // ЖК = жеке кәсіпкер, казахский аналог ИП
      ru: 'ИП Ташимов Э.К.'
    },
    address: {
      kk: 'Атырау қ., Құрманғазы ауданы, Мусаев 10',
      ru: 'г. Атырау, район Құрманғазы, Мусаев 10'
    }
  };
